...
export const Head: HeadFC = (props) => {
    ...
    return (
      <>
        ...
        <link rel="canonical" href={`${defaults.siteUrl}${localizedPath}`} />
        <meta property="og:url" content={`${defaults.siteUrl}${localizedPath}`} />
        ...
        <link
          ...
          href={
            ...
            (language === "es"
              ? "/en" + translated_routes[props.location.pathname]
              : invert(translated_routes)[props.location.pathname])
          }
        />
